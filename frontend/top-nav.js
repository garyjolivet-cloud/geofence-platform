...
(function(){
  ...
  async function init(opts){
    ...
    async function openManagePanel(){
      ...
      apps.forEach(app => {
        ...
        // Ridge Quest R7, 2026-08-20: whether this workspace appears at all in the
        // PUBLIC workspace picker (GET /api/quest-workspaces, no staff token needed).
        // Turning this on does NOT expose every project
  ...
  // Edit / GPX Editor are each a full page load, and every one
